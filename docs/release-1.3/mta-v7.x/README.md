...
Please refer to [the workflow README](https://github.com/parodos-dev/serverless-workflows/blob/v1.3.x/mta-v7.x/README.md#workflow-application-configuration)
