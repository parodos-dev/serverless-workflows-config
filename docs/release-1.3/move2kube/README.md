...
Please refer to [the workflow README](https://github.com/parodos-dev/serverless-workflows/blob/v1.3.x/move2kube/README.md#workflow-application-configuration)
