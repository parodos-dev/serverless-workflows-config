...
Please refer to [the workflow README](https://github.com/parodos-dev/serverless-workflows/blob/v1.2.x/create-ocp-project/README.md#workflow-application-configuration)
